import numpy as np
import cv2
bright=cv2.imread("C:/Users/G3/git_workspace/opencv/visionX/live_shape_color_detect/bright.jpg")
dark=cv2.imread("C:/Users/G3/git_workspace/opencv/visionX/live_shape_color_detect/dark.jpg")
...
resultBGR=cv2.resize(resultBGR,(400,500))
resultHSV=cv2.resize(resultHSV,(400,500))
resultYCB=cv2.resize(resultYCB,(400,500))
resultLAB=cv2.resize(resultLAB,(400,500))
